      ...
      <div className="container" style={{ paddingTop: '20px' }}>
        <section className="demo-video section-before section-padding-100">
          ...
          <SectionHeading
            ...
            title={[
              'Glimpse at ',
              <span style={{ color: '#E6791B' }}> Pre-Alpha </span>,
              ' Stage',
            ]}
            text2="We are focused on developing the game. While it runs, we decided to unveil a bit the curtain on the Alpha Stage of our world."
          />
